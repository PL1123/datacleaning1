...
Extract by grepl to generate a logical vector that can be used as index for merged dataset.  

3. Uses descriptive activity names to name the activities in the data set 
Change activities into a factor and label it. 

4. Appropriately labels the data set with descriptive variable names.
Label appropriate names using gsub. 
